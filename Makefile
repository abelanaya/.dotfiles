...
install: install-prerequisites install-prettier install-opencode install-cargo install-bat install-tokei install-fdfind install-kitty install-nvim install-tmux install-tmux-tpm install-fzf-brew install-oh-my-zsh install-powerlevel10k install-oh-my-zsh-plugins install-herdr
...
install-prerequisites-macos:
	brew tap FelixKratz/formulae satococoa/tap
	brew trust FelixKratz/formulae
	brew install libtool pkg-config automake ripgrep python3 xclip npm nmap dnsmap gucharmap tree stow wget ninja cmake gettext curl gh zoxide tldr borders btop pdfgrep magicmark/tap/spacelist lazygit lazydocker maccy direnv thefuck gh eza satococoa/tap/git-worktreeinclude hunk
...
install-prerequisites:
	...
	@brew install zoxide direnv thefuck gh eza satococoa/tap/git-worktreeinclude hunk
